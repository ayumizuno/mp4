...
Behind the glamorous visual effects and splendid plots, however, the profit might no longer justify the cost. To investigate the relationship between profit and cost, we pulled data on Disney animated films from the IMDB database, starting with *Three Little Pigs* in 1933, which runs for eight minutes, to the unsuccessful smartphone-themed *The Emoji Movie* in 2017, the latest record. The data confirms our gut feeling that an increase in the cost is a definite trend over time, but the relationship between cost and profit is muddy. 
...
Looking at the average profit and budget of animated films by decade, we can see that profit has a mostly downward trend ever since the 1960s, the decade filled with classic Disney animated films such as *The Jungle Book* and *One Hundred and One Dalmatians*. The nonparallel relationship between budget and profit persists even when we take into account the increase in animation production numbers in recent years. Although more and more animated films are produced over the decades, the sum of profit suffers a dip in the 2000s and fails to show a steep rise. At the same time, there is a robust upward trend in budget despite the weak profit.
...
Additionally, the top five movies with the highest budget are all from the 2010s: *Finding Dory*, *Inside Out*, *Zootopia*, *Frozen*, and *Moana*.However, when you take into account both the budget and the profit, older films seem to be winning the race. Although all of the movies in the 20 most profitable that were produced before the 1970s had low budgets, they were extremely successful.  
...
Classics like *Snow White* have become historical milestones, cultural icons, and a source of nostalgia. They continue to gain an upper hand in competition with new animated films: *Snow White*, which has the lowest budget out of the top three most profitable films, made greater profit than *Inside Out*.
...
The charm of animated films to investors also lie outside of the data. Most of the industry looks away from box-office for profits. According to *The Seattle Times*, financiers have been emboldened by the potential for fat returns outside of theaters. "'Frozen', with its massive \$1.3 billion in ticket sales, was dwarfed by an estimated \$6 billion in ancillary product revenue. Producers are almost thinking more about that side of the business and certainly earlier than ever before,” Piper Jaffray analyst Stan Meyer said. “It’s gone from toys to food and clothes and a bunch of other categories.”
