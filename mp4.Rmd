...
Additionally, the top five movies with the highest budget are all from the 2010s: *Finding Dory*, *Inside Out*, *Zootopia*, *Frozen*, and *Moana*.However, when you take into account both the budget and the profit, older films seem to be winning the race. Although all of the movies in the 20 most profittable that were produced before the 1970s had low budgets, they were extremely successful.  
