...
In addition, animation studios are producing animated filmsat a higher frequency. In the 2000s, 23 animated films were produced, and in the 2010s, 28 movies have already been produced despite that there are two more years to go. Maybe investing in multiple movies provides a safety vault for profit: as long as a few of them become big box busters, the studios are saved. 
